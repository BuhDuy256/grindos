...
* `description`: `TEXT` (Nullable) — *1–3 sentence explanation of what to do, why it matters, and what done looks like. Generated by Gemini alongside the title.*
* `duration_mins`: `INTEGER` (Not Null, must be multiples of 5).
* `is_completed`: `BOOLEAN` (Default: FALSE).
* `origin_type`: `VARCHAR(50)` (Not Null) — *Enforced Values: `SYSTEM_GENERATED`, `USER_CREATED`.*
